    ...
    <div class="get-rating-container">
      ...
      <form class="form raiting-form">
        ...
        <button class="raiting-form-submit" type="submit">Send</button>
                                    ...
                                    </button>`,t.dataset.favorite="false",z(s),o==="favorites.html"&&f()}function Ue({target:e}){if(He.includes(e.nodeName)&&e.classList[0]!=="favourites_btn_trash_icon"&&e.classList[0]!=="favourites_btn_workout")return N=e.dataset.id,Fe(N);if(e.classList[0]==="favourites_btn_trash_icon"){const t=e.dataset.id;z(t),f()}}Me.addEventListener("click",Ue);const Fe=async e=>{let t=await g.getOneExercises(e);const s=localStorage.getItem("favorites");s!==null&&JSON.parse(s).find(({_id:n})=>n===e)?t.favorite=!0:t.favorite=!1,h.open(P(t)),R=document.querySelector(".refresh-button-js"),A=document.querySelector(".add-rating"),A.addEventListener("click",Ae),R.addEventListener("click",Re)};export{p as a,we as c,g as f,H as m,c as s};
//# sourceMappingURL=exercises-right-part-filter-4aac166a.js.map
