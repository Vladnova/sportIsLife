var j=Object.defineProperty;var z=(e,t,s)=>t in e?j(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var S=(e,t,s)=>(z(e,typeof t!="symbol"?t+"":t,s),s);import{g as K,a as Q,i as G,b as Y,G as f,s as W,c as V,S as X}from"./vendor-938032cf.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerpolicy&&(a.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?a.credentials="include":n.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();const x=document.getElementById("home"),_=document.getElementById("favorites"),k=document.getElementById("home-text"),q=document.getElementById("favorites-text");document.getElementById("navigation");const Z=window.location.href.toString();let ee=Z.slice(-10);const te=()=>{ee==="index.html"?(x.classList.add("active"),k.classList.add("black"),_.classList.remove("active"),q.classList.remove("black")):(x.classList.remove("active"),k.classList.remove("black"),_.classList.add("active"),q.classList.add("black"))};te();const se=document.getElementById("burger-button"),w=document.getElementById("burger"),ne=document.getElementById("burger-button-close"),oe=async()=>{w.classList.remove("visually-hidden"),document.body.classList.add("disable-scroll")},ae=async e=>{w.classList.add("visually-hidden"),document.body.classList.remove("disable-scroll")},ie=e=>{e.key==="Escape"&&w.classList.add("visually-hidden"),document.body.classList.remove("disable-scroll")};se.addEventListener("click",oe);ne.addEventListener("click",ae);document.addEventListener("keydown",ie);const re={apiKey:"AIzaSyBNBMjRxNAY7Ev3P0n12UWF7CdjphLNQ5M",authDomain:"hosting-test-2fa75.firebaseapp.com",projectId:"hosting-test-2fa75",storageBucket:"hosting-test-2fa75.appspot.com",messagingSenderId:"882269537085",appId:"1:882269537085:web:b0e1d25d79d88d76b4bb54"},ce=K().length?Q():G(re),$=Y(ce),le=new f,g=document.getElementById("sign-in"),p=document.getElementById("sign-out"),E=document.getElementById("user");E.innerHTML=localStorage.getItem("user");localStorage.getItem("user")&&(p.classList.remove("display-none"),g.classList.add("display-none"));const de=async()=>{await W($,le).then(e=>{f.credentialFromResult(e).accessToken;const s=e.user;localStorage.user=s.email,E.innerHTML=s.email,p.classList.remove("display-none"),g.classList.add("display-none")}).catch(e=>{e.message,e.customData.email;const t=f.credentialFromError(e);console.log(t)})},ue=async()=>{await V($).then(()=>{E.innerHTML="",localStorage.removeItem("user"),console.log("Sign-out successful.")}).catch(e=>{console.log(e.message)}),p.classList.add("display-none"),g.classList.remove("display-none")};g.addEventListener("click",de);p.addEventListener("click",ue);function me(e){return"*".repeat(e)}function ge(e){return`<div class="modal-info">
    ...
    <div class="get-rating-container">
  ...
  </div>`}class A{constructor(){this.overlay=document.querySelector(".overlay"),this.modal=document.querySelector(".modal-info"),this.closeButton,this.closeButtonHandler=()=>this.close(),this.escapeKeyHandler=t=>this.closeEsc(t),this.overlayClickHandler=t=>this.closeBack(t)}open(t){this.overlay.innerHTML=t,this.overlay.style.zIndex=1,this.overlay.style.display="flex",this.modal.classList.remove("visually-hidden"),this.closeButton=document.querySelector(".modal-button-close"),document.body.classList.add("no-scroll"),this.closeButton.addEventListener("click",this.closeButtonHandler),document.addEventListener("keydown",this.escapeKeyHandler),this.overlay.addEventListener("click",this.overlayClickHandler)}close(){this.modal=document.querySelector(".modal-info")||document.querySelector(".modal-get-raiting"),this.overlay.style.display="none",this.overlay.style.zIndex=-1,this.modal.classList.add("visually-hidden"),document.body.classList.remove("no-scroll"),this.closeButton.removeEventListener("click",this.closeButtonHandler),document.removeEventListener("keydown",this.escapeKeyHandler),this.overlay.removeEventListener("click",this.overlayClickHandler)}closeEsc(t){t.key==="Escape"&&this.close()}closeBack(t){t.target===this.overlay&&this.close()}}new A;const i=class{static handleErrors(t){return async()=>{try{return await t()}catch(s){console.error("Помилка при запиті: ",s.message)}}}static async fetchJson(t,s){return(await fetch(t,s)).json()}async getQuotes(){return await i.handleErrors(async()=>await i.fetchJson(`${i.BASE_URL}/quote`))()}async getByFilterName(t){return await i.handleErrors(async()=>{const o=new URLSearchParams({...t});return await i.fetchJson(`${i.BASE_URL}/filters?${o}`)})()}async getByFilterCategory(t){return await i.handleErrors(async()=>{const o=new URLSearchParams({...t});return await i.fetchJson(`${i.BASE_URL}/exercises?${o}`)})()}async getOneExercises(t){return await i.handleErrors(async()=>await i.fetchJson(`${i.BASE_URL}/exercises/${t}`))()}async addExercisesRate(t,s){return await i.handleErrors(async()=>{const n={method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)};return await i.fetchJson(`${i.BASE_URL}/exercises/${t}/rating`,n)})()}async addSubscription(t){return await i.handleErrors(async()=>{const o={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)};return await i.fetchJson(`${i.BASE_URL}/subscription`,o)})()}};let m=i;S(m,"BASE_URL","https://your-energy.b.goit.study/api");const l=new m,v=document.querySelector(".pagination-numbers"),he=document.querySelector(".muscles-list");let y=1;try{v.addEventListener("click",fe),v.addEventListener("click",T)}catch(e){console.log(e)}async function fe(e){const{totalPages:t,categoryName:s}=JSON.parse(localStorage.getItem("infoRequest")),o={filter:s,page:e.target.textContent,limit:12,totalPages:t};if(o.page===y)return;const a=(await l.getByFilterName(o)).results;he.innerHTML=O(a),y=o.page,be()}const ve=e=>{const t=document.createElement("button");t.className="pagination-number",t.innerHTML=e,t.setAttribute("page-index",e),t.setAttribute("aria-label","Page "+e),v.appendChild(t)};function ye(){const{totalPages:e}=JSON.parse(localStorage.getItem("infoRequest"));if(e!==1)for(let t=1;t<=e;t++)ve(t)}function be(e){b(),document.querySelectorAll(".pagination-number").forEach(t=>{Number(t.getAttribute("page-index"))&&t.addEventListener("click",()=>{b()})})}function b(e){T(),handlePageButtonsStatus()}function T(){document.querySelectorAll(".pagination-number").forEach(e=>{e.classList.remove("active"),Number(e.getAttribute("page-index"))==y&&e.classList.add("active")})}const Le=document.querySelector(".wrap-button"),H=document.querySelector(".muscles-list"),we=document.querySelector(".pagination-numbers");Le.addEventListener("click",Ee);document.addEventListener("DOMContentLoaded",()=>{P({filter:"Muscles",page:1,limit:12})});async function Ee(e){e.preventDefault();const{target:t,currentTarget:s}=e;if(t.nodeName!=="BUTTON")return;const o=t.dataset.name;console.log(t.classList),t.classList.contains("btn-filter")&&[...s.children].forEach(r=>{r.firstElementChild.classList.remove("btn-filter-active")}),t.classList.add("btn-filter-active");const n={filter:o,page:1,limit:12};H.innerHTML="",P(n),document.querySelector(".filter-list-js").classList.add("muscles-section")}async function P(e){try{const t=await l.getByFilterName(e),s=t.results;if(!t||s.length===0){console.log("Sorry, we didn't find anything according to your request.");return}H.insertAdjacentHTML("beforeend",O(s));const{totalPages:o}=t,n=JSON.stringify({totalPages:o,categoryName:e.filter});localStorage.setItem("infoRequest",n),we.innerHTML="",ye(),b(1)}catch(t){console.log(t.message)}}function O(e){return e.map(({filter:s,name:o,imgURL:n})=>{let a=s.toLocaleLowerCase().replaceAll(" ","");return a==="bodyparts"&&(a="bodypart"),`
      ...
      <div class="exercises_list_item_up">
        ...
        <div class="exercises_list_item_up_right">
          <button class="exercises_btn_start">
            ...
            <svg class="exercises_btn_start_icon" width="56px" height="18px" aria-label="arrow">
      ...
      <div class="exercises_list_item_middle">
        <div class="exercises_list_item_middle_icon">
          <svg class="exercises_list_item_middle_icon_svg" width="24px" height="24px" aria-label="run-man">
            <use xlink:href="./img/svg/sprite.svg#icon-run-man"></use>
            />
          </svg>
        </div>
        <h3 class="exercises_list_item_middle_title">${a}</h3>
      </div>
...
//# sourceMappingURL=spinner-f8dac679.js.map
